 ...
 */
class Ps_checkout7361AdminContainer extends Container
{
    private $parameters;
    private $targetDirs = [];
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.5.1', '/var/www/html', true);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.5.1', '/var/www/html');
    }
